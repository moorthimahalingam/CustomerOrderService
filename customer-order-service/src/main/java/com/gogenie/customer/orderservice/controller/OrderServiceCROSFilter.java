...
public class OrderServiceCROSFilter implements Filter {

	Logger logger = LoggerFactory.getLogger(OrderServiceCROSFilter.class);
	
	public OrderServiceCROSFilter() {
		logger.debug("OrderServiceCROSFilter constructor");
	}
